...
from qthmi.tag import Tag
from qthmi.main.widgets import  HMIDoubleSpinBox, HMILabel, HMIComboBox, HMIPushButton, HMIIndicator
...
class TestDialog(QDialog):
    def __init__(self, parent=None):
        ...
        tag2 = self.connector.add_tag(Tag("second", 10))
